...
const TEST_API = "thumbnails.roblox.com/v1/assets?assetIds=135649239598036&returnPolicy=PlaceHolder&size=512x512&format=Webp&isCircular=false";

fetch("https://cors-anywhere.com/" + TEST_API)
	.then(res => res.json())
